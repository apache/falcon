 ...
 *       &lt;sequence>
 *         &lt;element name="controls" type="{uri:oozie:coordinator:0.2}CONTROLS" minOccurs="0"/>
 *         &lt;element name="datasets" type="{uri:oozie:coordinator:0.2}DATASETS" minOccurs="0"/>
 *         &lt;element name="input-events" type="{uri:oozie:coordinator:0.2}INPUTEVENTS" minOccurs="0"/>
 *         &lt;element name="output-events" type="{uri:oozie:coordinator:0.2}OUTPUTEVENTS" minOccurs="0"/>
 *         &lt;element name="action" type="{uri:oozie:coordinator:0.2}ACTION"/>
 *       &lt;/sequence>

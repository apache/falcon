...
public class DatabaseImportWorkflowBuilder extends ImportWorkflowBuilder {
    ...
    protected Properties getWorkflow(Cluster cluster, WORKFLOWAPP workflow, Path buildPath)
        ...
        ImportExportCommon.addHCatalogProperties(props, entity, cluster, buildPath, workflow, this);
        return props;
    }
    ...
    private StringBuilder buildTargetTableArg(StringBuilder builder, CatalogTable catalog)
        throws FalconException {
        ...
        Map<String, String> partitionsMap = getPartitionKeyValues(partitions);
    ...
    private Map<String, String> getPartitionKeyValues(String partitionStr) {

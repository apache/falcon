 ...
 * generated in the org.apache.airavat.oozie.coordinator package. 
...
public class ObjectFactory {
    ...
    private final static QName _Datasets_QNAME = new QName("uri:oozie:coordinator:0.1", "datasets");
    private final static QName _CoordinatorApp_QNAME = new QName("uri:oozie:coordinator:0.1", "coordinator-app");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.apache.airavat.oozie.coordinator
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "uri:oozie:coordinator:0.1", name = "datasets")
     ...
     * 
     */
    @XmlElementDecl(namespace = "uri:oozie:coordinator:0.1", name = "coordinator-app")

...
import org.apache.ivory.entity.v0.datastore.Configuration;
...
public class ConfigurationTypeAdapter extends
  ...
  @Override
  public org.apache.ivory.entity.common.Configuration unmarshal(Configuration v) throws Exception {
  ...
  @Override
  public Configuration marshal(org.apache.ivory.entity.common.Configuration v) throws Exception {
    if (v == null) return null;

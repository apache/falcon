...
public final class PersistenceConstants {
    ...
    public static final String GET_ALL_RECIPES = "GET_ALL_RECIPES";
    public static final String GET_RECIPE_LOCATION = "GET_RECIPE_LOCATION";
    public static final String DELETE_ALL_RECIPES = "DELETE_ALL_RECIPES";
}

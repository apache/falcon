...
public class ExtensionManagerIT extends AbstractTestExtensionStore {
    ...
    private static final String SOURCE_DIR = "/apps/falcon/adf-demo/input-{year}-{month}-{day}";
    private static final String TARGET_DIR = "/apps/falcon/adf-demo/output-{year}-{month}-{day}";

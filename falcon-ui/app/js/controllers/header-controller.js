...
(function () {
  ...
  angular.module('app.controllers.navHeader', ['app.services.entity.model', 'ngCookies'])

    .controller('HeaderController', ['$rootScope', "$scope", '$state', 'EntityModel',
                                     function($rootScope, $scope, $state, EntityModel) {

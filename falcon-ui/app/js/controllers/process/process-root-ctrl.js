...
(function () {
  ...
  feedModule.controller('ProcessRootCtrl',
    ['$scope', '$state', '$interval', '$controller', 'EntityFactory', 'EntitySerializer', 'X2jsService',
      function($scope, $state, $interval, $controller, entityFactory, serializer, X2jsService) {

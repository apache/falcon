...
import static org.apache.falcon.cli.FalconAdminCLI.STACK_OPTION;
import static org.apache.falcon.cli.FalconAdminCLI.STACK_OPTION_DESCRIPTION;
import static org.apache.falcon.cli.FalconAdminCLI.STATUS_OPT;
import static org.apache.falcon.cli.FalconAdminCLI.STATUS_OPT_DESCRIPTION;
import static org.apache.falcon.cli.FalconAdminCLI.VERSION_OPT;
import static org.apache.falcon.cli.FalconAdminCLI.VERSION_OPT_DESCRIPTION;
...
public class FalconAdminCommands extends BaseFalconCommands {
    ...
    public String status(
        ...
        String url = getClientProperties().getProperty(FALCON_URL_PROPERTY);
        if (status != 200) {
